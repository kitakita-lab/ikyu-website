...
export const products: Product[] = [
  {
    ...
    description:
      "腕もとでゆれる一本のラインに、ドライフラワーをとじこめました。金属の光と花の色が、袖口からのぞくたびに小さく華やぎます。", // ★要確認: 作り手の言葉に直してください
    images: [
      // 1枚目=メイン(一覧カードにも使われる)
      {
      ...
      },
      {
        ...
        alt: "白い袖もとの手首で揺れる、花をとじこめたゴールドのフラワーバングル(着用イメージ)",
      },
      {
        src: "/images/product-bangles.webp",
        alt: "ヴィンテージのガラスの器に掛かる、ドライフラワーをとじこめた透明レジンとゴールドのバングル",
      },
    ],
    size: "—", // ★差し替え: 例)内径 約6cm
    ...
    images: [
      {
        ...
        alt: "窓からの光の筋の中、ドライフラワーをとじこめたレジンと細いゴールドのリングをつけた手元",
      },
    ],
